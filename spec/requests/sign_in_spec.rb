...
describe "sign in", :type => :request do
    ...
    before do
      ...
      User.create(first_name: "mayur",last_name: "deshmukh",contact_number: "2132131231", is_admin: false, email: "ksnehanjali@gmail.com",city_id: 1, password: "123456", password_confirmation: "123456")
